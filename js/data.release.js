...
window.NERC.release = {
  ...
  scope: "Pre-SME remediation release plus GitHub Pages Progressive Web App packaging for iPad Home Screen installation and offline use",
  officialSources: [
    ...
    { id: "standards", title: "NERC Reliability Standards One Stop Shop", version: "reviewed July 25, 2026", url: "https://www.nerc.com/standards/reliability-standards" },
  ...
  pwa: { edition: "GitHub Pages / iPad offline", cacheVersion: "pwa1", offlineRuntime: true, externalVideoLinksOffline: false },
  limitations: [
